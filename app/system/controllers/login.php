...
switch ($do) {
    ...
    default:
        // Hotspot / end-users: never show traditional username/password login.
        // Captive portal lands on packages (portal controller). Admin login stays at /admin.
        // Stock hotspot URL hitting login: MAC auto-pass if known + active package.
